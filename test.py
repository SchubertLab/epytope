...
results = predictor.predict(tcr_repertoire, [epitope_1] * len(tcr_repertoire.receptors), repository="/ATM-TCR", conda="ergo", pairwise=False)
print(results)
...
results = predictor.predict(tcr_repertoire, [epitope_1] * len(tcr_repertoire.receptors), repository="/PanPep", conda="ergo", pairwise=False)
print(results)
...
results = predictor.predict(tcr_repertoire, [epitope_1] * len(tcr_repertoire.receptors), repository="/DLpTCR", conda="deepTCR", pairwise=False)
print(results)
#predictor = TCRSpecificityPredictorFactory("stapler")
#results = predictor.predict(tcr_repertoire, [epitope_1] * len(tcr_repertoire.receptors), repository="/STAPLER", conda="stapler", pairwise=False)
#print(results)
