...
results = predictor.predict(tcr_repertoire, [epitope_1] * len(tcr_repertoire.receptors), repository="/home/icb/anna.chernysheva/TEINet", conda="teinet", model="/home/icb/anna.chernysheva/TEINet/teinet_data.pth", pairwise=False)
results.to_csv("out_single.csv")

predictor = TCRSpecificityPredictorFactory("teinet")
results = predictor.predict(tcr_repertoire, [epitope_1, epitope_2], repository="/home/icb/anna.chernysheva/TEINet", conda="teinet", model="/home/icb/anna.chernysheva/TEINet/teinet_data.pth", pairwise=True)
