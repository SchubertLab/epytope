...
results = predictor.predict(tcr_repertoire, [epitope_1] * len(tcr_repertoire.receptors), repository="/home/icb/anna.chernysheva/DLpTCR", conda="dltcr", model_type="B", pairwise=False)
results.to_csv("out_single.csv")

predictor = TCRSpecificityPredictorFactory("dlptcr")
results = predictor.predict(tcr_repertoire, [epitope_1, epitope_2], repository="/home/icb/anna.chernysheva/DLpTCR", conda="dltcr", model_type="B", pairwise=True)
