...
results = predictor.predict(tcr_repertoire, [epitope_1] * len(tcr_repertoire.receptors), repository="/home/icb/anna.chernysheva/TEINet", conda="teinet", model="../../../TEINet/results/teinet_data.pth", pairwise=False)
