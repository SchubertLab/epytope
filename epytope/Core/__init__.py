...
from epytope.Core.Allele import *
from epytope.Core.Generator import *
from epytope.Core.Peptide import *
from epytope.Core.Protein import *
from epytope.Core.Transcript import *
